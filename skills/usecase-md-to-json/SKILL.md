...
# Use Case Markdown to JSON and Diagram Converter / UC仕様Markdown→JSONコンバーター

**UML Workflow v3 ヘルパースキル / Helper Skill**

Markdown形式のユースケース仕様書（Cockburn形式）を `usecase-output.json` と PlantUML ユースケース図に変換します。  
Converts Cockburn-format Markdown use case specs to `usecase-output.json` and a PlantUML use case diagram.
...
### Step 0: Language Configuration / 言語設定
...
### Use Case 1: After Reviewing Markdown Specifications / UC1: Markdown仕様書レビュー後
...
### Use Case 2: Adding New Extension Flow / UC2: 代替フロー追加
...
### Use Case 3: Adding New Use Case / UC3: 新規ユースケース追加
...
### Step 1: Scan Markdown Files / Markdownファイルのスキャン
...
### Step 2: Parse Each Markdown File / 各Markdownファイルの解析
...
## Markdown Parsing Rules / Markdownパース規則
